    ...
    <div class="container">
        <div class="row">
            <div class="col s4">
                ...
                <label class="label-top">Все роли</label>
                <ul class="collection">
                    <?php foreach ($roles as $role): ?>
                        <li class="collection-item">
                            <div><?=$role->name?><a href="javascript:;" data-url="<?=url('role/' . $role->id . '/delete')?>" class="secondary-content red-text role-delete"><i class="material-icons">delete</i></a></div>
                        </li>
                    <?php endforeach; ?>
                </ul>
